...
const ButtonControl = {
    ...
    properties: {
      ...
      BorderColor: { type: "colour", description: "The color of the control's border." },
      Color: { type: "colour", description: "The color of text in the control." },
      Fill: { type: "colour", description: "The background color of the control." },
  ...
  const GalleryControl = {
    ...
    properties: {
      ...
      TemplateFill: { type: "colour", description: "The background color of a control instance." },
  ...
  const DataTableControl = {
    ...
    properties: {
      ...
      BorderColor: { type: "colour", description: "The color of the control's border." },
      HeaderColor: { type: "colour", description: "The background color of the header row." },
      Height: { type: "number", description: "The distance between the control's top and bottom edges." },
      Width: { type: "number", description: "The distance between the control's left and right edges." },
      X: { type: "number", description: "The distance from the left edge of the control to the left edge of its parent." },
      Y: { type: "number", description: "The distance from the top edge of the control to the top edge of its parent." },
  ...
  const CanvasControl = {
    ...
    properties: {
      ...
      Fill: { type: "colour", description: "The background color of the canvas." },
      Width: { type: "number", description: "The distance between the control's left and right edges." },
      Height: { type: "number", description: "The distance between the control's top and bottom edges." },
      LoadingSpinnerColor: { type: "colour", description: "The color of the loading spinner that appears while the app loads." },
  ...
  const SliderControl = {
    ...
    properties: {
      ...
      OnChange: { type: "function", description: "How the app responds when the user changes the value." },
      Fill: { type: "colour", description: "The background color of the control." },
      HandleFill: { type: "colour", description: "The color of the slider's handle." },
      RailFill: { type: "colour", description: "The color of the slider's rail." },
      Height: { type: "number", description: "The distance between the control's top and bottom edges." },
      Width: { type: "number", description: "The distance between the control's left and right edges." },
      X: { type: "number", description: "The distance from the left edge of the control to the left edge of its parent." },
      Y: { type: "number", description: "The distance from the top edge of the control to the top edge of its parent." },
  ...
  const CheckBoxControl = {
    ...
    properties: {
      ...
      CheckmarkFill: { type: "colour", description: "The color of the checkmark." },
      BorderColor: { type: "colour", description: "The color of the control's border." },
      Color: { type: "colour", description: "The color of text in the control." },
      Fill: { type: "colour", description: "The background color of the control." },
      DisplayMode: { type: "enum", options: ["Edit", "View", "Disabled"], description: "Whether the control allows user input." },
  ...
  const IconControl = {
    ...
    examples: [
        ...
        },
        {
          ...
          description: "Change icon color based on data source status"
        },
        {
    ...
    properties: {
      ...
      Color: { type: "colour", description: "The color of the icon." },
      Fill: { type: "colour", description: "The background color of the control." },
      OnSelect: { type: "function", description: "How the app responds when the user selects the control." },
  ...
  const PenInputControl = {
    ...
    examples: [
        ...
        },
        {
          ...
          description: "Change pen color based on dropdown selection"
        },
    ],
    properties: {
      ...
      BorderColor: { type: "colour", description: "The color of the control's border." },
      Color: { type: "colour", description: "The color of the pen." },
      Fill: { type: "colour", description: "The background color of the control." },
  ...
  const RatingControl = {
    ...
    examples: [
        ...
        },
        {
          ...
          description: "Change rating color based on value"
        },
    ],
    properties: {
      ...
      RatingFill: { type: "colour", description: "The color of selected rating symbols." },
      Color: { type: "colour", description: "The color of unselected rating symbols." },
      DisplayMode: { type: "enum", options: ["Edit", "View", "Disabled"], description: "Whether the control allows user input." },
      Height: { type: "number", description: "The distance between the control's top and bottom edges." },
      Width: { type: "number", description: "The distance between the control's left and right edges." },
      X: { type: "number", description: "The distance from the left edge of the control to the left edge of its parent." },
  ...
  const ProgressBarControl = {
    ...
    examples: [
        ...
        },
        {
          ...
          description: "Change color based on progress value"
        },
        {
    ...
    properties: {
      ...
      BarColor: { type: "colour", description: "The color of the progress indicator." },
      Fill: { type: "colour", description: "The background color of the control." },
      BorderColor: { type: "colour", description: "The color of the control's border." },
      Height: { type: "number", description: "The distance between the control's top and bottom edges." },
      Width: { type: "number", description: "The distance between the control's left and right edges." },
  ...
  const PieChartControl = {
    ...
    examples: [
        ...
        },
        {
          ...
          description: "Set color palette for pie chart slices"
        },
    ],
    properties: {
      ...
      ColorPalette: { type: "string", description: "The color scheme for the slices." },
